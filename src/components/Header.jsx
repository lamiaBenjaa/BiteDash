  ...
  return (
    <nav className='px-8 py-4 lg:px-24 w-full m-auto shadow-md shadow-gray-950 md:flex md:justify-between md:items-center'>
      ...
      <ul className={`${menu ? style2 : style}}`}>
        ...
        <li><Link to='/Menu' className={`${location.pathname === '/Menu' ? 'text-gray-50 border-b-4 border-gray-50' : 'text-gray-300 hover:text-orange-400 hover:border-b-4 border-orange-400 duration-200 '}`}>Menu</Link></li>
